...
<meta charset="UTF-8">
    ...
    <title>Methodist Charles Wesley</title>
...
<body class="main">
    <nav class="navbar navbar-expand-lg navbar-light bg-light navbarHome fixed-top text-dark">
        <div class="container">
            ...
            <a class="navbar-brand" href="index.php">
                <img src="images/logo2.png" alt="Logo SMP/SMA/SMK Methodist Charles Wesley">
    ...
    <div class="footer">
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="footerContactUs">
                        ...
                        <div class="perFooterContactUs">
                            ...
                            <p class="text-white">info@methodistcw.sch.id</p>
                            <p class="text-white">methodistcw@gmail.com</p>
                        </div>
        
                        <div class="perFooterContactUs">
                            <i class="fas text-white fa-phone-alt"></i>
                            <p class="text-white">(061)-4277 1542</p>
                            <p class="text-white">0878 6912 3707 (WA) / 0813 7724 1686</p>
                        </div>
        
                        <div class="perFooterContactUs">
                            <i class="fas text-white fa-road"></i>
                            <p class="text-white">Komplek CBD. Polonia Blok CC No.108
                                Jl. Padang Golf (dalam)
                ...
                <div class="col-md-4">
                    ...
                    <div class="footerAbout">
                        <a href="" class="text-white">List Buku</a>
        ...
        <p class="text-white">
            <i class="far fa-copyright"></i>2022 By : <span>Kelompok 1</span>&nbsp;
        </p>
        </div>
